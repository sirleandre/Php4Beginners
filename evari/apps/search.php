<?php
       ...
       if( !$button )
             ...
             if( strlen( $search ) <= 1 )
                    ...
                    mysql_connect( "localhost","root","mozal") ; 
                    ...
                    $construct = " SELECT * FROM students WHERE $construct ";
                    ...
                    if ($foundnum == 0)
                           ...
                           while( $runrows = mysql_fetch_assoc( $run ) ) {
                                  $title = $runrows ['student_name'];
                                  $desc = $runrows ['student_city'];
                                  $url = $runrows ['student_email'];
                                  $da = $runrows ['reg_date'];
